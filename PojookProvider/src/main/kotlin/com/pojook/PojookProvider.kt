            ...
            document.select(".se-c").mapNotNull {
                ...
                it.select(".episodiotitle a").mapNotNull {epsBtn ->
                    ...
                    if(itEps != null) {
                        ...
                        val parsedItEps = Episode(
                                data = "$mainUrl$href",
                                name = "Episode $episodeNumber - Unknown Episode Name",
                                season = seasonNumber,
                                episode = episodeNumber,
                                posterUrl = bgPoster,
                                rating = 0,
                                description = "Nonton $resTitle Season $seasonNumber Episode $episodeNumber Subtitle Indonesua"
                        )
            ...
            if (it.attr("data-nume") != "trailer") {
                ...
                if(embedData.embed_url.contains("fa.efek.stream")) {
                    ...
                    for (quality in qualities) {
                        ...
                        if(actualLink != null) {
                            callback.invoke(ExtractorLink("VIP Server", "VIP Server HD", actualLink, "https://fa.efek.stream", quality, type = ExtractorLinkType.VIDEO))
                        }
                    }
                }
            }
